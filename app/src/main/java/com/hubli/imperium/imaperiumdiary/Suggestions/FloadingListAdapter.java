...
public class FloadingListAdapter extends ArrayAdapter<sc_items>{
    ...
    public View getView(final int position, final View convertView, ViewGroup parent) {
        ...
        if(spData.getUserData(SPData.PROPIC_URL).contentEquals(item.getProfilePic_link()) || !spData.isStudent()){
                ...
                public void onClick(View v) {
                    ...
                    alert.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            volley.setUrl(URL.SUGGESTION_COMPLAIN);
        ...
        Picasso.with(getContext()).load(URL.SERVER_URL+item.getProfilePic_link())
